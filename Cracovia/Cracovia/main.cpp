...
void koniec()
{
    ...
    fstream zapis;
    zapis.open("/Users/hubert/Documents/Xcode/C/Cracovia/Cracovia/highscore.txt", ios::out | ios::app);
    zapis<<playerName[0]<<playerName[1]<<playerName[2]<<playerName[3]<<playerName[4]<<playerName[5]<<"     "<<killed_end<<"        "<<money_end<<"       "<<move_end<<endl;
    zapis.close();
...
void random_shop(){
    ...
    cout<<"7-Kup morgensztern (OBR 1-25) - "<<cena_weapon6<<endl;
        ...
        case 51:
                ...
                cout<<"Kupiono miksturę ZB!"<<endl;
                    
                }break;
        case 52:
                {woda+=1;
                Wengle=Wengle-cena_hp;
                cout<<"Kupiono butelke wody!"<<endl;
                   
                }break;
        case 53:
                {weapon_main=4;
                Wengle=Wengle-cena_weapon4;
                cout<<"Kupiono długi miecz!"<<endl;
                   
                }break;
        case 54:
                {weapon_main=5;
                Wengle=Wengle-cena_weapon5;
                cout<<"Kupiono podwójne sztylety!"<<endl;
                    
                }break;
        case 55:
                {weapon_main=6;
                Wengle=Wengle-cena_weapon6;
                cout<<"Kupiono morgensztern!"<<endl;
...
void random_food(){
    ...
    cout<<"Zdobyto "<<hunt<<" racji żywnościowych!"<<endl;
    food=food+hunt;
}
//
...
for( int i = 0; i < 5; i++){
    ...
    start:
    cout<<"Cracovia - Simple Text Based RPG"<<endl;
    cout<<"1 - Start"<<endl;
    cout<<"2 - Sala Sław"<<endl;
    ...
    switch (menu) {
        case 1:
            ...
            break;
        case 2:
            cout<<"Gracz    Zabici    Waluta    Ruchy"<<endl;
            fstream uchwyt;
            uchwyt.open("/Users/hubert/Documents/Xcode/C/Cracovia/Cracovia/highscore.txt");
            string linia;
            do
               {
